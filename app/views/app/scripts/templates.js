...
'개의 결과를 찾았습니다.</h5>\n    </div>\n    <div class="col s3">\n      <button id="btn-research" class="btn waves-effect color-news" type="button">다시 검색하기</button>\n    </div>\n  </div>\n  <div class="row search-cards">\n  ';
